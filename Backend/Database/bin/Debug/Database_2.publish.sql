...
END
GO
PRINT N'Refreshing Procedure [dbo].[GetUserDetails]...';


GO
EXECUTE sp_refreshsqlmodule N'[dbo].[GetUserDetails]';


GO
PRINT N'Refreshing Procedure [dbo].[GetUserDetailsWithUsername]...';


GO
EXECUTE sp_refreshsqlmodule N'[dbo].[GetUserDetailsWithUsername]';
